...
### 2025-10-05: Корректировка сортировки в UI (в процессе)
**Проблема:** Неинтуитивный порядок отображения часовых блоков и событий внутри них.
**Решение:** После анализа конвейера данных принято решение принудительно сортировать данные непосредственно в UI-компонентах для обеспечения желаемого порядка отображения. Нужно отсортировать события внутри часа от старых к новым.
