...
**Далее** нужно улучшить тултип. для одиночных выводим все данные с новой строки. для группированных выводим саммари (чистая и грязная длительности, число событих уникальных и общее) и на следующих строках по возможности делаем аски таблицу:
1 программаА, тайтл, процент, время, айди входящих
2 программаБ, тайтл, процент, время, айди входящих
...
N афк, процент, время

**Далее** добавить санацию тайтлов от звездочек и точек (файл не сохранен) в начале.

**Далее** обсудить громоздкость и сделать дорожки юай сильно компактнее.

**Далее** придумать как выводить в детали часа два вида подробности одновременно: агрегированно и подробно
